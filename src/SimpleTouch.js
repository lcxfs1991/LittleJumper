...
TouchRecognizer.prototype.beginPoint = function(x, y) {
    this.points = [];
    this.result = "";
...
TouchRecognizer.prototype.movePoint = function(x, y) {
    this.points.push(new Point(x, y));
...
TouchRecognizer.prototype.endPoint = function() {
...
TouchRecognizer.prototype.getPoints = function() {
    return this.points;
}